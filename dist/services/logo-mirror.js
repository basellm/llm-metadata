 ...
 */
export async function mirrorProviderLogos(providers, dirs, options = {}) {
    const warnings = [];
    ...
    const fetchLogo = async (entry) => {
        ...
        if (options.force || !existsSync(cachePath)) {
            try {
                ...
                warnings.push(`logo: failed to fetch ${entry.url} (${error instanceof Error ? error.message : String(error)})`);
            }
        }
...
//# sourceMappingURL=logo-mirror.js.map